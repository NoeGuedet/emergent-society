...
Constraint coming from the research: Constraint Pinning protects *literal* constraints (Governance Decay: 0% → 30-59% violation after compaction, pinning → 0%); a *rich and implicit* direction is not pinnable as is. Hence two linked forms, versioned together:
